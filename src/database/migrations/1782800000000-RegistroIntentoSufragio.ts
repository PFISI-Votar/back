 ...
 * Columna `clave_intento` (no `votante_hash`) para cumplir invariante VOTAR-379.
 */
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      CREATE TABLE "registro_intento_sufragio" (
        ...
        "clave_intento" character varying(64) NOT NULL,
        "votos_consumidos" integer NOT NULL DEFAULT 0,
        "ultimo_intento_at" TIMESTAMP WITH TIME ZONE,
        "creado_en" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
        "actualizado_en" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
        CONSTRAINT "UQ_registro_intento_eleccion_clave"
          UNIQUE ("id_eleccion", "clave_intento"),
    ...
    `);
    await queryRunner.query(`
      CREATE INDEX "IDX_registro_intento_clave"
        ON "registro_intento_sufragio" ("clave_intento")
    `);
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP INDEX "public"."IDX_registro_intento_clave"`);
    await queryRunner.query(
