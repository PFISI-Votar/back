...
import { CampoCandidatoDefinicion } from '../interfaces/campo-candidato-definicion.interface';
...
describe('CandidatoDatosValidatorService', () => {
  ...
  it('debe rechazar campo obligatorio faltante', () => {
    ...
    try {
      ...
      const response = (error as DatosAdicionalesValidationException).getResponse() as {
        errors: { clave: string }[];
      };
