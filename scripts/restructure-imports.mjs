...
const replacements = [
  [
    '@/eleccion/entities/lista.entity',
    '@/eleccion/lista/entities/lista.entity',
  ],
  [
    '@/eleccion/entities/boleta.entity',
    '@/eleccion/lista/entities/boleta.entity',
  ],
  [
    '@/eleccion/entities/categoria.entity',
    '@/eleccion/lista/entities/categoria.entity',
  ],
  [
    '@/eleccion/entities/candidato.entity',
    '@/eleccion/candidato/entities/candidato.entity',
  ],
  [
  ...
  [
    '@/eleccion/dto/lista-response.dto',
    '@/eleccion/lista/dto/lista-response.dto',
  ],
  ...
  [
    '@/eleccion/enums/estado-lista.enum',
    '@/eleccion/lista/enums/estado-lista.enum',
  ],
  [
    '@/eleccion/enums/estado-boleta.enum',
    '@/eleccion/lista/enums/estado-boleta.enum',
  ],
  [
  ...
  [
    '@/eleccion/services/lista.service',
    '@/eleccion/lista/services/lista.service',
  ],
  [
    '@/eleccion/services/boleta.service',
    '@/eleccion/lista/services/boleta.service',
  ],
  [
  ...
  [
    ...
    '@/eleccion/candidato/services/candidato.service',
  ],
  [
  ...
  [
    '@/eleccion/controllers/lista.controller',
    '@/eleccion/lista/controllers/lista.controller',
  ],
  [
